...
---------------------------|-----------------|----------------------------------------------------------------------
 ...
 `upstream_tag_template`   | string          | template to create an upstream tag name (upstream may use different tagging scheme) using python string formatting, e.g.: "v{version}", where packit will fill in the version argument
