...
---------------------------|-----------------|----------------------------------------------------------------------
 ...
 `create_pr`               | bool            | when doing a new update in Fedora dist-git, should packit create a new pull request (when set to `true`) or push directly to dist-git (defaults to `false`)
