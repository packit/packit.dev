...
---------------------------|-----------------|----------------------------------------------------------------------
 ...
 `spec_source_id`          | int or string   | Numeric ID of Source inside spec file which packit should change when setting path to the newly generated tarball, can be, int or string - full name of the macro
