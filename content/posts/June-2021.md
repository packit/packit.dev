...
- Hunor made several improvements to `source-git init:`

  - added an option to specify a packaging tool;
  - renamed package_name to pkg_name

- Jiri - set project_dir as a fact

- Laura added `from_downstream` argument for getting SyncFilesItem for specfile,
  fixing https://sentry.io/organizations/red-hat-0p/issues/2466591748/?project=1767823&query=is%3Aunresolved

- The TMT plan name was corrected.

- Jiri made some changes to secrets handling:

  - secrets/ directory now has packit/ subdirectory
  - put dev.yml into vars/packit/

- Frantisek made all COPR projects shared among all releases.
