...
In case `.pre-commit-config.yaml` is not found at the rooot of the repository, this behavior is skipped and can be forced using the `--force-precommit` flag. Please note that the
